fishSDM.prediction.df<- function(rcp85.mu.dir, rcp85.pct05.dir, rcp85.pct95.dir, rcp45.mu.dir, rcp45.pct05.dir, rcp45.pct95.dir, oisst.dir, sp.in, dates.baseline, dates.future, seasonal.mu, season, model.dat) {
  ...
  if(FALSE) {
    ...
    oisst.dir<- "~/Box/Mills Lab/Projects/COCA15_ClimVuln/COCA-SDM/Data/1981to2015_OISST_Projected.grd"
    sp.in<- "~/Box/Data/Shapefiles/"
    #dates<- c("2015-10-16")
    seasonal.mu<- TRUE
    season<- "Fall"
...
fall.rast.pred<- fishSDM.prediction.df(rcp45.mu.dir = paste(res.data.path, "CMIP5_SST/RCP45_mu.grd", sep = ""),  rcp45.pct05.dir = paste(res.data.path, "CMIP5_SST/RCP45_5th.grd", sep = ""), rcp45.pct95.dir = paste(res.data.path, "CMIP5_SST/RCP45_95th.grd", sep = ""), rcp85.mu.dir = paste(res.data.path, "CMIP5_SST/RCP85_mu.grd", sep = ""),  rcp85.pct05.dir = paste(res.data.path, "CMIP5_SST/RCP85_5th.grd", sep = ""), rcp85.pct95.dir = paste(res.data.path, "CMIP5_SST/RCP85_95th.grd", sep = ""), oisst.dir = "~/Box/Mills Lab/Projects/COCA15_ClimVuln/COCA-SDM/Data/1981to2015_OISST_Projected.grd", sp.in = "~/Box/Data/Shapefiles/", dates.baseline = c("2011-10-16", "2012-10-16", "2013-10-16", "2014-10-16", "2015-10-16"), dates.future =  c("2004-10-16", "2012-10-16", "2025-10-16", "2040-10-16", "2055-10-16", "2100-10-16"), seasonal.mu = TRUE, season = "Fall", model.dat = "~/GitHub/COCA/Data/dat.fitted.biomass.rds")
fall.rast.pred$SEASON<- "FALL"
saveRDS(fall.rast.pred, file = "~/Box/Mills Lab/Projects/COCA15_ClimVuln/COCA-SDM/Data/fall.rast.preds.10162018.rds")
...
saveRDS(spring.rast.pred, file = "~/Box/Mills Lab/Projects/COCA15_ClimVuln/COCA-SDM/Data/spring.rast.preds.10162018.rds")
